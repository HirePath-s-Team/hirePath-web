export const blogPosts = [
  {
    ...
    minutes: 8,
    heroTheme: "from-[#233358] via-[#0f1528] to-[#1a1635]",
    imageTheme: "from-[#22345f] via-[#141c33] to-[#0f1528]",
    sections: [
      {
...
const { fields, append, remove } = useFieldArray({
  ...
  },
  {
    ...
    minutes: 6,
    heroTheme: "from-[#2a2f4d] via-[#121a31] to-[#1a1635]",
    imageTheme: "from-[#2b2f4f] via-[#141c33] to-[#0f1528]",
    sections: [
      {
...
4. Analyze complexity`,
  },
  {
    ...
    minutes: 7,
    heroTheme: "from-[#1f2b4a] via-[#0f1528] to-[#1a1635]",
    imageTheme: "from-[#1f2b4a] via-[#141c33] to-[#0f1528]",
    sections: [
      {
...
• DP (1D + 2D)`,
  },
  {
    ...
    minutes: 5,
    heroTheme: "from-[#242f53] via-[#0f1528] to-[#1a1635]",
    imageTheme: "from-[#242f53] via-[#141c33] to-[#0f1528]",
    sections: [
      {
...
Result: ...`,
  },
  {
    ...
    minutes: 4,
    heroTheme: "from-[#1e2c4a] via-[#0f1528] to-[#1a1635]",
    imageTheme: "from-[#1e2c4a] via-[#141c33] to-[#0f1528]",
    sections: [
      {
