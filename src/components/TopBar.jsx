...
export function TopBar() {
    ...
    return (<header className="sticky top-0 z-40 flex min-h-14 items-center justify-between gap-3 border-b border-border bg-card/70 px-4 py-2 backdrop-blur-sm md:px-6">
      ...
      <div className="flex shrink-0 items-center gap-2 md:gap-3">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <button className="ml-2 inline-flex items-center gap-2 rounded-full bg-gradient-to-br from-primary to-accent px-3 py-1.5 text-xs font-semibold text-foreground">
              JP
