    ...
    <AppLayout>
      <div className="max-w-6xl mx-auto space-y-6">
        <div>
          ...
          <p className="mt-2 text-sm text-muted-foreground">Structured paths to get interview ready.</p>
        </div>
        ...
        <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-4">
          {roadmaps.map((roadmap, index) => {
            ...
            return (
              <div key={roadmap.id} className="flex flex-col gap-4 rounded-2xl border border-border bg-card/40 p-5 shadow-sm">
                <div className="flex items-center justify-between">
                  <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-secondary/55 text-primary">
                ...
                <Button asChild className="mt-auto h-10">
