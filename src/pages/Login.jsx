...
const Login = () => {
    ...
    return (<div className="min-h-screen flex bg-background">
      {/* Left panel ? branding */}
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden items-center justify-center bg-stars">
        {/* Gradient blobs */}
        <div className="absolute inset-0">
          <div className="absolute top-1/4 left-1/4 h-72 w-72 rounded-full bg-primary/20 blur-[120px]"/>
          <div className="absolute bottom-1/3 right-1/4 h-64 w-64 rounded-full bg-accent/20 blur-[100px]"/>
        </div>

        <div className="relative z-10 max-w-md px-8 text-center">
          <div className="flex items-center justify-center gap-3 mb-8">
            <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-primary to-accent">
              <span className="text-xl font-bold text-foreground">H</span>
            </div>
            <span className="text-3xl font-bold text-foreground tracking-tight">HirePath</span>
          </div>
      ...
      <div className="flex flex-1 items-center justify-center p-8">
        <div className="w-full max-w-sm space-y-8">
          ...
          <div className="lg:hidden flex items-center gap-2 justify-center mb-4">
            ...
            <span className="text-2xl font-bold text-foreground tracking-tight">HirePath</span>
          </div>
          ...
          <div className="space-y-3">
            <Button variant="outline" className="w-full h-11 gap-3 border-border bg-card hover:bg-muted text-foreground" onClick={() => navigate("/dashboard")}>
