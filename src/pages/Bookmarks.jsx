        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.7fr_1fr] gap-6">
          <div className="space-y-4">
            {filtered.length === 0 ? (
              ...
              filtered.map((q) => (
                <div key={q.id} className="rounded-2xl border border-border bg-card/40 px-4 py-4 hover:bg-card/70 transition-colors">
                    ...
                    <div className="flex-1 space-y-2">
                      <div className="flex flex-wrap items-center justify-between gap-3">
                        ...
                        <div className="flex flex-wrap items-center gap-2">
                          <Badge variant="outline" className="border-border bg-[#1b2b52]/40 text-xs text-foreground">
                            {q.list}
                          </Badge>
