...
import { CheckCircle, Flame, CalendarDays, Target, TrendingUp, ArrowUpRight, Zap, BookOpen, } from "lucide-react";
...
const Dashboard = () => {
    ...
    return (<AppLayout>
      <div className="max-w-7xl mx-auto space-y-8">
        {/* Hero greeting */}
        <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 p-8 text-foreground shadow-xl backdrop-blur-xl">
          ...
          <div className="relative z-10">
            ...
            <p className="mt-2 text-muted-foreground max-w-lg">
              You've solved {dashboardStats.questionsSolved} problems and
              maintained a {dashboardStats.longestStreak}-day streak. Keep the
              momentum going.
            </p>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-border text-left">
                  ...
                  <th className="px-6 py-3 text-xs font-medium text-muted-foreground uppercase tracking-wider">Companies</th>
