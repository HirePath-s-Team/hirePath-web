  ...
  return (
    <AppLayout>
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div className={`rounded-2xl border border-border bg-gradient-to-br ${post.imageTheme} p-2 shadow-sm`}>
          <div className="h-64 w-full rounded-xl bg-[radial-gradient(circle_at_20%_20%,_rgba(90,120,255,0.25),_transparent_60%)]" />
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-2xl border border-border bg-card/40 p-6">
            ...
            <pre className="mt-4 whitespace-pre-wrap text-sm text-foreground/90 leading-relaxed font-mono bg-background/60 rounded-xl p-5 border border-border">
{post.code}
            </pre>
          </div>
        </div>

        <div className="rounded-2xl border border-border bg-card/40 p-6 flex flex-wrap items-center justify-between gap-4">
          <div>
