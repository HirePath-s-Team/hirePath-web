...
import { questionsBank, allCompanies } from "@/data/questionsData";
...
export default function Questions() {
  ...
  useEffect(() => {
    ...
    setSearch(q);
    setCompany(companyParam && allCompanies.includes(companyParam) ? companyParam : "all");
  }, [searchParams]);

  const updateQueryParams = (nextSearch, nextCompany) => {
    ...
    if (nextCompany && nextCompany !== "all") {
        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <Select value={difficulty} onValueChange={(v) => { setDifficulty(v); setPage(1); }}>
              <SelectTrigger className="h-9 w-[130px] border-border bg-card text-sm">
          ...
          <div className="relative min-w-[220px] flex-1">
            ...
            <Input
              ...
              onChange={(e) => {
                ...
                setSearch(value);
                setPage(1);
                updateQueryParams(value, company);
              }}
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 space-y-2">
                        <div className="flex flex-wrap items-center justify-between gap-3">
                          ...
                          <div className="flex flex-wrap items-center gap-2">
                            <Badge variant="outline" className="border-border bg-secondary/45 text-xs text-foreground">{q.topic}</Badge>
                            <Badge variant="outline" className="border-border bg-secondary/45 text-xs text-foreground">{q.difficulty}</Badge>
                          </div>
                        </div>
                        <div className="flex flex-wrap items-center gap-2">
              ...
              <div className="flex items-center justify-between pt-2">
                ...
                <div className="flex items-center gap-1">
                  ...
                  {Array.from({ length: totalPages }, (_, i) => i + 1).map((p) => (
                    <Button key={p} variant={p === currentPage ? "default" : "outline"} size="sm" onClick={() => setPage(p)} className="h-8 w-8 border-border">
                      {p}
                    </Button>
                  ))}
